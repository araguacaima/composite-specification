...
import org.araguacaima.commons.utils.MapUtils;
...
public class SpecificationMapUtil {
    ...
    private static final Map<String, SpecificationMap>            instancesMap = new HashMap<>();
    ...
    private static SpecificationMap getInstance(Properties properties, Class clazz) {
    ...
    public static SpecificationMap getInstance(File propertiesFile, Class clazz) {
        return buildInstance(PropertiesHandlerUtils.getInstance(propertiesFile, clazz.getClassLoader()).getProperties(),
                clazz,
                false,
