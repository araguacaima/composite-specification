...
public abstract class MathFunctionExpression implements Expression {
    ...
    MathFunctionExpression(double value) {
        this(value, false);

    }

    private MathFunctionExpression(double value, boolean evaluateAllTerms) {
        this.value = value;
