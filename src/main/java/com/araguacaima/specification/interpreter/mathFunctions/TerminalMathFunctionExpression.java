...
public class TerminalMathFunctionExpression extends MathFunctionExpression implements Expression, TerminalExpression {
    private final String var;

    public TerminalMathFunctionExpression(String v) {
        var = v;
    }

    public Expression evaluate(Context c)
            throws ExpressionException, ContextException {
        return new MathFunctionExpressionImpl(((MathFunctionContext) c).getValue(var));
    }
