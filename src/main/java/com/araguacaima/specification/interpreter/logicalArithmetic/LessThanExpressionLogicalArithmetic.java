...
public class LessThanExpressionLogicalArithmetic extends NonTerminalLogicalArithmeticExpression {
    public LessThanExpressionLogicalArithmetic(Expression l, Expression r) {
        super(l, r);
    }
