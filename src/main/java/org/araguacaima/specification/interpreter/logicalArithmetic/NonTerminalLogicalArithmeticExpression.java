...
public abstract class NonTerminalLogicalArithmeticExpression extends LogicalArithmeticExpression
    ...
    NonTerminalLogicalArithmeticExpression(Expression l, Expression r) {
        this(false, l, r);
    }

    private NonTerminalLogicalArithmeticExpression(boolean evaluateAllTerms, Expression l, Expression r) {
        super();
